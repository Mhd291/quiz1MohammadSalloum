...
Test1 _$Test1FromJson(Map<String, dynamic> json) {
  return _Test1.fromJson(json);
}
...
class _$Test1Impl implements _Test1 {
  const _$Test1Impl({required this.company});

  factory _$Test1Impl.fromJson(Map<String, dynamic> json) =>
      _$$Test1ImplFromJson(json);
...
abstract class _Test1 implements Test1 {
  const factory _Test1({required final Company company}) = _$Test1Impl;

  factory _Test1.fromJson(Map<String, dynamic> json) = _$Test1Impl.fromJson;
